...
describe('UserControllerService', () => {
  ...
  it('#getAllUsers',
    inject([HttpTestingController],
      (httpMock: HttpTestingController) => {
        ...
        const returnValue = service.getAllUsers();
  ...
  it('#getUserByEmail',
    inject([HttpTestingController],
      (httpMock: HttpTestingController) => {
        ...
        const returnValue = service.getUserByEmail('jedimasterdjd@yahoo.com');
  ...
  it('#getCurrentUserObservable',
    inject([HttpTestingController],
      (httpMock: HttpTestingController) => {
        ...
        const returnValue = service.getCurrentUserObservable();
  ...
  it('#getRegistrationKey should call POST and return',
    inject([HttpTestingController],
      (httpMock: HttpTestingController) => {
        ...
        const testRTR = new RegistrationToken();
  ...
  it('#update',
    inject([HttpTestingController],
      (httpMock: HttpTestingController) => {
        ...
        const returnValue = service.update();
  ...
  inject([HttpTestingController],
    (httpMock: HttpTestingController) => {
      ...
      const returnValue = service.updateBio('Test Bio');
